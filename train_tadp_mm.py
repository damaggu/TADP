...
from TADP.tadp_seg_mm import TADPSeg
...
def parse_args():
    ...
    parser.add_argument('--dreambooth_checkpoint', type=str, default=None)
    ...
    ## CANNOT ADD ARGS HERE, SCROLL UP TO WHERE parser.parse_args() is called -----
...
def main():
    ...
    cfg.model['opt_dict'] = {
        ...
        'dreambooth_checkpoint': args.dreambooth_checkpoint,
    }
    if args.sd_ckpt_path is not None:
        cfg.model['ckpt_path'] = args.sd_ckpt_path
    ...
    print("No Validate:", args.no_validate)
    train_segmentor(
        model,
        datasets,
        cfg,
