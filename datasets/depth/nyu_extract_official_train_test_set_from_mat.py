#!/usr/bin/env python
# -*- coding: utf-8 -*-
# Copied from VPD: https://github.com/wl-zhao/VPD/blob/main/depth/extract_official_train_test_set_from_mat.py
...
if __name__ == "__main__":
    ...
    # TODO: @ Markus what does this line do? also there was a previous version that created class names do we need that
