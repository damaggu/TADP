...
https://github.com/wl-zhao/VPD/blob/main/segmentation/test.py
"""
...
from TADP.utils.modified_mm_test import single_gpu_test, multi_gpu_test
from TADP.tadp_seg_mm import TADPSeg  # keep import to register model
...
def main():
    ...
    if args.debug:
        ...
        test_loader_cfg['persistent_workers'] = False
